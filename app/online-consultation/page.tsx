  ...
  return (
    <div className="min-h-screen bg-cream-50/30">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div className="relative z-10 space-y-6 sm:space-y-8 animate-slide-up">
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-sage-100 border border-sage-200/50 mt-2 sm:mt-0">
                <span className="flex h-2 w-2 rounded-full bg-terracotta-500 animate-pulse" />
                <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-sage-800">Now Accepting New Patients</span>
              </div>
              ...
              <p className="text-base sm:text-lg leading-relaxed text-sage-700 max-w-xl">
                Experience the peak of homeopathic excellence from the comfort of your sanctuary. Our virtual concierge bridges the gap between traditional wisdom and modern convenience.
              </p>

              <div className="flex flex-col sm:flex-row gap-4 pt-4 sm:pt-6">
                <Link href="#request-form" className="btn-premium w-full sm:w-auto px-8 py-4 sm:px-10 sm:py-5 text-base text-center">
                  Book Virtual Slot
                </Link>
                <Link href="/about" className="btn-outline-premium w-full sm:w-auto px-8 py-4 sm:px-10 sm:py-5 text-base text-center">
                  The Revive Way
                </Link>
              </div>
            ...
            <div className="relative h-[300px] sm:h-[400px] lg:h-[600px] animate-fade-in delay-300">
              ...
              {/* Floating element */}
              <div className="absolute bottom-4 left-4 sm:-bottom-6 sm:-left-6 glass-card p-4 sm:p-6 max-w-[180px] sm:max-w-[240px] animate-float z-20">
                <div className="flex items-center gap-2 sm:gap-3 mb-2 sm:mb-3">
                  <div className="h-8 w-8 sm:h-10 sm:w-10 rounded-full bg-sage-100 flex items-center justify-center text-sm sm:text-base text-sage-600">🌿</div>
                  <p className="text-xs sm:text-sm font-bold text-sage-900">Holistic First</p>
                </div>
                <p className="text-[10px] sm:text-xs text-sage-600 leading-relaxed">
                  "Our virtual sessions are designed to be even more personal than in-person visits."
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 lg:py-24 bg-white overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <h3 className="section-heading">Why Online Consultation at Revive?</h3>
          </div>

          <div className="grid md:grid-cols-3 gap-8">
            {experienceFeatures.map((feature, idx) => (
              <div key={idx} className="p-8 sm:p-10 rounded-4xl bg-cream-50/50 border border-sage-100 hover:bg-white hover:shadow-xl transition-all duration-500 group mx-2 sm:mx-0">
                ...
                <h4 className="text-xl font-bold text-sage-900 mb-3">{feature.title}</h4>
                <p className="text-sm text-sage-600 leading-relaxed">{feature.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 lg:py-24 relative overflow-hidden">
        <div className="absolute top-0 right-0 -translate-y-1/2 translate-x-1/4 w-[600px] h-[600px] bg-terracotta-50 rounded-full blur-3xl opacity-50 -z-10" />
        
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-[1fr_1.2fr] gap-12 lg:gap-16 items-center">
            <div className="relative h-[300px] sm:h-[400px] lg:h-[500px] rounded-[2.5rem] sm:rounded-[3rem] overflow-hidden shadow-xl border border-sage-200">
              <Image
                src={lifestyleImg}
            ...
            <div>
              ...
              <h3 className="section-heading mb-10">From First Inquiry to <br />Curated Healing.</h3>
              
              <div className="space-y-10">
                {processSteps.map((step, idx) => (
                  <div key={idx} className="flex gap-4 sm:gap-6 relative">
                    {idx !== processSteps.length - 1 && (
                      <div className="absolute left-6 top-12 bottom-[-2.5rem] w-px bg-sage-200" />
                    )}
                    ...
                    <div>
                      <h4 className="text-lg font-bold text-sage-900 mb-1.5">{step.title}</h4>
                      <p className="text-sm text-sage-600 leading-relaxed max-w-md">{step.text}</p>
                    </div>
                  </div>
                ))}
              </div>
      ...
      {/* Form Section */}
      <section className="py-16 lg:py-24 bg-sage-900 relative overflow-hidden" id="request-form">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid lg:grid-cols-[0.8fr_1.2fr] gap-16 items-start">
            <div className="text-white lg:sticky lg:top-32">
              <h2 className="section-kicker !text-terracotta-300">Ready to Begin?</h2>
              <h3 className="text-4xl md:text-5xl font-playfair font-bold mt-4 mb-8 leading-tight">
                Your healing <br />journey is one <br />click away.
              </h3>
              <p className="text-sage-200 text-lg leading-relaxed mb-10 max-w-md">
                Don't let distance define your quality of care. Our virtual clinic is open, personal, and dedicated to your constitutional wellness.
              </p>
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-[10px] font-bold uppercase tracking-widest text-terracotta-300">Fast Track</p>
                    <p className="text-lg font-bold">{contactData.clinic_info.phone.primary}</p>
                  </div>
                </div>
                <div className="flex items-center gap-4">
                  <div className="h-12 w-12 rounded-2xl bg-white/10 flex items-center justify-center text-xl">💬</div>
                  <div>
                    <p className="text-[10px] font-bold uppercase tracking-widest text-terracotta-300">Available Mode</p>
                    <p className="text-lg font-bold">Video / Audio / Home Visit</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-4">
            {[
              ...
              <div key={idx} className="p-8 rounded-3xl border border-sage-100 bg-cream-50/30 hover:border-sage-200 hover:bg-white hover:shadow-lg transition-all duration-300">
                <h4 className="text-lg font-bold text-sage-900 mb-3">{faq.q}</h4>
